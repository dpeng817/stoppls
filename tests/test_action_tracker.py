...
class TestActionTracker:
    ...
    def mock_reply_action(self):
        ...
        return RuleAction(type="reply", parameters={"text": "Test reply"})

    @pytest.fixture
    def mock_archive_action(self):
        """Create a mock archive action."""
        return RuleAction(type="archive", parameters={})

    @pytest.fixture
    def mock_label_action(self):
        """Create a mock label action."""
        return RuleAction(type="label", parameters={"label": "Test Label"})
    ...
    def test_record_action(self, temp_storage_file, mock_message, mock_reply_action):
        ...
        tracker.record_action(
            message=mock_message, action=mock_reply_action, rule_name="Test Rule"
        )
    ...
    def test_clear_old_actions(
        self, temp_storage_file, mock_message, mock_reply_action
    ):
    ...
    def test_send_daily_report(
        self, temp_storage_file, mock_message, mock_reply_action, mock_email_provider
    ):
        ...
        success = tracker.send_daily_report(
            email_provider=mock_email_provider, recipient_email="recipient@example.com"
        )
    ...
    def test_check_and_send_daily_report_time_to_send(
        self, temp_storage_file, mock_email_provider
    ):
        ...
        tracker = ActionTracker(storage_path=temp_storage_file, report_time=report_time)
    ...
    def test_check_and_send_daily_report_not_time_yet(
        self, temp_storage_file, mock_email_provider
    ):
    ...
    def test_check_and_send_daily_report_already_sent_today(
        self, temp_storage_file, mock_email_provider
    ):
